...
export const DEMO_IDS = {
  policies: {
    ...
    seriousDiseaseMedicalAssistance: "policy-023",
    illnessPovertyMedicalAssistance: "policy-024",
    distressedChildrenClassification: "policy-025",
    familyPlanningSpecialAssistance: "policy-026",
    legalAidCommitment: "policy-027",
    publicRentalHousingApplication: "policy-028",
    disabledSelfEmploymentInsuranceSubsidy: "policy-029",
    studentAidFunds: "policy-030",
    elderlyMealService: "policy-031",
  },
  residents: {
